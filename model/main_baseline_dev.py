...
file_names = glob.glob('../DevSets/**/*.txt', recursive=True)
corpus_file_names = []
...
with open('model_baseline_param_75.txt', 'w+') as output_file:
    with open('../evaluation/Questions_dev.txt', 'r') as questions_file:
